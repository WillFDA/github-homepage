  ...
  return (
    <Container>
      <div className="text-white bg-transparent py-5">
        <div className="flex items-center max-lg:justify-between max-lg:flex-row">
          ...
          >
            <div className="flex max-lg:flex-col lg:items-center max-sm:w-10/12 max-sm:mx-auto sm:ml-auto max-lg:w-[320px] lg:justify-between lg:w-full max-lg:max-h-[500px] overflow-y-auto lg:mb-0 max-lg:bg-white max-lg:rounded-lg">
              ...
              <div className="lg:flex items-center max-lg:flex-col lg:px-0 px-3 mb-3 lg:mb-0 text-left lg:space-x-4">
                <div className="lg:flex mb-2 lg:mb-0 relative max-lg:mr-4">
                  <input
                    ...
                    className="glass max-lg:bg-neutral-50 max-lg:w-full w-[240px] lg:px-2 h-[38px] p-[3.5px] whitespace-nowrap placeholder:text-[14px] font-medium placeholder:pl-2 focus:z-10 focus:outline-none focus:text-black border-[1px] lg:border-neutral-500 max-lg:border-neutral-300 rounded-md"
                  />
                  <svg
